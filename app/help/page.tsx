                            ...
                            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-slate-300 hover:shadow">
                                ...
                                <div className="mt-3 flex flex-wrap gap-2">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-flex items-center gap-2 rounded-md border border-slate-300 bg-slate-50 px-3 py-1.5 text-xs font-semibold text-slate-700 transition-all duration-150 hover:-translate-y-px hover:bg-slate-100 hover:shadow-sm"
                                    >
                            ...
                            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-slate-300 hover:shadow">
                                ...
                                <div className="mt-3">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-flex items-center gap-2 rounded-md border border-indigo-300 bg-indigo-50 px-3 py-1.5 text-xs font-semibold text-indigo-700 transition-all duration-150 hover:-translate-y-px hover:bg-indigo-100 hover:shadow-sm"
                                    >
                                        <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-hidden="true">
